  ...
  ({ className, ...props }: MessageResponseProps) => (
    <Streamdown
      className={cn(
        ...
        "[&_pre]:max-h-none [&_pre]:overflow-x-auto [&_pre]:overflow-y-visible [&_pre]:rounded-xl [&_pre]:border [&_pre]:border-border/60 [&_pre]:bg-[#0d1117] [&_pre]:font-mono [&_pre]:text-[13px] [&_pre]:text-zinc-300",
        "[&_code]:rounded-md [&_code]:bg-muted/80 [&_code]:px-1 [&_code]:py-0.5 [&_code]:font-mono [&_code]:text-xs",
        className
      )}
